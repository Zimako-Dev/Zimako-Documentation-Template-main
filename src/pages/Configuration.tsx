...
export function Configuration() {
  ...
  return (
    <div className="prose dark:prose-invert prose-indigo max-w-none">
      ...
      <p>
        Configuration is handled through a central config file:
      </p>
  ...
  "database": {
    ...
    "port": 5432
      ...
      <ul>
        <li><code>APP_SECRET</code> - Application secret key</li>
        <li><code>DB_PASSWORD</code> - Database password</li>
        <li><code>API_KEYS</code> - External service API keys</li>
      </ul>

      <h2>Advanced Options</h2>
      <p>
        The platform supports various advanced configuration options for
        fine-tuning performance and behavior:
      </p>
      <ul>
